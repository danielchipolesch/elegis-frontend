<template>
    <!-- A classe "fill-height" na tag v-container centraliza verticalmente todos os itens da página.  -->
                ...
                <v-col cols="12">
                    <v-card title="Nutrition" flat>
                        ...
                        <v-data-table :headers="headers" :items="desserts" :search="search"
                            ...
                            <template v-slot:top>
                                <v-toolbar flat>
                                    <v-toolbar-title>Meus Documentos</v-toolbar-title>
                                    <!-- <v-divider
                        class="mx-4"
                        inset
                        vertical
                      ></v-divider> -->
                                    ...
                                    <v-dialog v-model="dialog" max-width="500px">
                                        <template v-slot:activator="{ props }">
                                            <v-btn prepend-icon="mdi-plus" class="mb-2" color="primary" variant="tonal"
                                                v-bind="props">
                                                Novo
                                            </v-btn>
                                        </template>
